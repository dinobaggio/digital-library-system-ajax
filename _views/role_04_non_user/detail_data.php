...
if(isset($_POST['id'])) {
    ...
    try {
        ...
        if ($data['kategori'] == 'jurnal') {
            $pdfFIle = "pdfjs-1.9.426-dist/web/viewer2.html?file=../../upload/ebook/$nama_file/abstrak";
        } else {
            $pdfFIle = "pdfjs-1.9.426-dist/web/viewer2.html?file=../../upload/ebook/$nama_file/non_user";
        }
        ?>
    ...
    <div class="" style='display:block'>
        <div id='detail' class='w3-cell w3-text-black' style='padding-left:5%;width:0%'>
        ...
        <div id='viewPdf' class='w3-cell' style='height:400px;display: block;margin-top:-25%;margin-left:40%'>
            <span id='tutup' class="w3-button w3-right w3-text-black" style='display:none;margin-top:-5%'><i class="fa fa-remove" ></i></span>
    ...
    <footer class="w3-container w3-teal" style='margin-top:20%'>
        <p><button class="w3-button w3-gray" id='lihat'>Lihat</button></p>
    </footer>
            ...
            */
            ...
            if( terlihat == 0 ){
                $('#tesObejct').show('slow', function(){
                    $('#tesObejct').append("<object data='<?php echo $pdfFIle?>.pdf#zoom=90' id='tesView' class='tesView' style='margin-left:-10%;padding-right:10%;height:150%;width:115%'></object>");
                });
