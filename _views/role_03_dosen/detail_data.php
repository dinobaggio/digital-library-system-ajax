...
if(isset($_POST['id'])) {
    ...
    <div class="" style='display:block'>
        <div id='detail' class='w3-cell' style='padding-left:5%;width:0%'>
        ...
        <div id='viewPdf' class='w3-cell' style='height:400px;display: block;margin-top:-25%;margin-left:40%'>
            <span id='tutup' class="w3-button w3-right" style='display:none;margin-top:-5%'><i class="fa fa-remove" ></i></span>
